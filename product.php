...
<body id="rl">
<div class="menu"> <a href="index.php"> <strong> Home </strong> </a> </div>
<div class="container">
    ...
    <div id="tabs">
        ...
        <div id="tabs-2">
            ...
            <td> <h2> <input type="checkbox"> A919 Duo </h2> </td>
            <p> Check if want this item!!! </p>
            <img src="images/A919 Duo.png"/>
            <p>Go for big time features with the latest and BIGGEST Android offering of MyPhone, yet. It’s a total powerhouse in terms of design and specs. From sophisticated style and streamlined design, 8MP auto focus camera plus front camera for video calls, up to 3G connectivity, an immensely powerful dual-core 1GHz processor and Android 4.0.4. OS; name it, and the new MyPhone A919 Duo has it. Plus, get bigger and better entertainment from its huge 5” FWVGA IPS display.


                MyPhone A919 also comes with a unique TV-OUT function that lets you connect your phone to TV sets or LCD screens so you can truly take your mobile viewing and gaming experience to a whole level with the phone’s upsized screen. That’s just like having your very own movie projector and gaming console in one phone!
